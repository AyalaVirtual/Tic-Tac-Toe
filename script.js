...
function playGame(event) {
    ...
    if (currentPlayer === "Player 1" && (clickedBox.innerHTML !== "X" || clickedBox.innerHTML !== "O")) {
    ...
    } else if (currentPlayer === "Player 2" && (clickedBox.innerHTML !== "X" || clickedBox.innerHTML !== "O")) {
            
        clickedBox.innerHTML = "O";

        if ((topLeftValue === "O" && topMiddleValue === "X" && topRightValue === "O") || (middleLeftValue === "O" && centerValue === "O" && middleRightValue === "O") || (bottomLeftValue === "O" && bottomMiddleValue === "O" && bottomRightValue === "O") || (topLeftValue === "O" && centerValue === "O" && bottomRightValue === "X") || (topRightValue === "O" && centerValue === "O" && bottomLeftValue === "O")) {
